...
<project-brief>
# Projeto: Site da Nova Arena Ciacollor

## Idioma
Toda a interface e os textos (copy) devem ser em **português do Brasil (pt-BR)**.

## O negócio
**Nova Arena Ciacollor** — arena de **futebol society** em Maringá-PR. O site precisa fazer o cliente entender o espaço em segundos e agir rápido.

## Objetivos do site (em ordem de prioridade)
1. **Agendar campo** — CTA principal. Todo botão de agendamento abre o **WhatsApp** com mensagem pré-preenchida (não há sistema de calendário online; a confirmação é feita na conversa).
2. **Entender o espaço** — mostrar a estrutura e o diferencial da arena.
3. **Virar mensalista** — explicar as vantagens do horário fixo semanal e converter via WhatsApp.
4. **Acessar o canal do YouTube** — onde os jogos são transmitidos/gravados.
5. Redes sociais e localização.

## Stack
- O site atual é um projeto **Next.js hospedado no Vercel** (substituirá `novaarena.vercel.app`).
- Implementar com **Next.js + Tailwind CSS**, **Framer Motion** (scroll/parallax/acordeão) e **react-fast-marquee** (marquees), conforme o design system abaixo.

## Override de cor da marca (IMPORTANTE)
O design system Kinetic Typography especifica o accent como amarelo ácido (`#DFE104`). **Substitua o accent pela cor da marca da Nova Arena:**
- `accent` (cor da marca): **`#FF5C00`** (laranja)
- `accent-secondary` (complementar): **`#EF7D00`**
- `accent-foreground`: preto/near-black quente (`#241200`) para texto sobre o laranja

Todo o resto do design system (preto rico `#09090B`, off-white `#FAFAFA`, mutados zinc, bordas zinc-700, escala tipográfica, marquees, brutalismo) permanece igual. Onde o design system disser "acid yellow", leia "laranja `#FF5C00`".

## Dados de contato e operação (usar em todo o site)
- **WhatsApp / telefone:** (44) 99914-9952 → link `https://wa.me/5544999149952`
- **Endereço:** R. Allan Kardec, 1737 – Parque Avenida, Maringá – PR, CEP 87025-410
- **Google Maps (embed/link):** `https://www.google.com/maps?q=R.+Allan+Kardec,+1737+-+Parque+Avenida,+Maring%C3%A1+-+PR,+87025-410`
- **Horário de funcionamento:**
  - Segunda a sexta: 17h00 – 00h00
  - Sábado: 14h00 – 20h00
  - Domingo: 08h00 – 12h00
- **YouTube:** `https://www.youtube.com/@NovaArenaTV` (canal: @NovaArenaTV)
- **Instagram:** `https://www.instagram.com/novaarenaciacollor/`
- **Preços:** não exibir valores públicos — usar CTA "Consultar valores" que leva ao WhatsApp.

## Mensagens pré-preenchidas do WhatsApp (URL-encoded)
- **Agendar:** `https://wa.me/5544999149952?text=Ol%C3%A1!%20Quero%20agendar%20um%20hor%C3%A1rio%20na%20Nova%20Arena%20Ciacollor.`
- **Mensalista:** `https://wa.me/5544999149952?text=Ol%C3%A1!%20Quero%20ser%20mensalista%20na%20Nova%20Arena%20Ciacollor%20e%20saber%20os%20valores.`

## Seções e conteúdo (estrutura da página única)
1. **Header fixo** — logo da Nova Arena + navegação (Nosso Espaço, Agendar, Mensalista, YouTube, Onde Estamos) + botão "Agendar agora" sempre visível. Menu hambúrguer no mobile.
2. **Hero** — headline em escala gigante (kinetic), subtítulo curto e 2 CTAs: "Agendar pelo WhatsApp" (primário) e "Conhecer o espaço" (outline). Badge "Arena Society • Maringá-PR".
3. **Marquee de stats/energia** (fundo laranja) — frases/números que reforçam a vibe (ex: horários, "JOGO TODO DIA", etc.). Marquee rápido, sem gradiente.
4. **Barra de info rápida** — endereço, horário e telefone visíveis logo de cara.
5. **Nosso Espaço** — features em cards brutalistas com inversão de cor no hover. Itens: Gramado de alto padrão; Iluminação noturna; Vestiário e estrutura; Estacionamento; Bar e lanchonete; Transmissão dos jogos (YouTube). Incluir galeria de fotos do espaço.
6. **Como Agendar** — 3 passos (01 escolher dia/horário · 02 chamar no WhatsApp · 03 jogar) com números decorativos gigantes (8–12rem), seguidos de CTA grande de WhatsApp.
7. **Seja Mensalista** — vantagens (horário fixo semanal, valor especial, prioridade nas datas, sem reagendar toda semana, condições em eventos/torneios) + CTA "Consultar valores".
8. **YouTube** — destaque do canal @NovaArenaTV, com player/CTA "Acessar nosso canal" e a ideia de reviver os melhores lances dos jogos.
9. **Marquee de depoimentos** (mais lento) — espaço para depoimentos de clientes (placeholder até receber reais).
10. **FAQ** (acordeão) — Como reservar; Valores (consultar no WhatsApp); Como funciona o mensalista; Fornecem bola/coletes; Organizar campeonatos/eventos.
11. **Localização** — mapa do Google embutido + endereço + menção a estacionamento no local.
12. **CTA final** — chamada de impacto ("Bora jogar?") com botão de WhatsApp.
13. **Footer** — logo, redes (Instagram, YouTube, WhatsApp), navegação, contato e horários.
14. **Botão flutuante de WhatsApp** persistente em todas as telas.

## Assets pendentes (deixar placeholders bem marcados)
- **Logo oficial** da Nova Arena (substituir o placeholder textual).
- **Fotos reais** do espaço (campo, iluminação, bar, vestiário) — usar imagens placeholder até receber.
- **ID de vídeo do YouTube** para embed (ou manter player clicável que abre o canal).

## Escopo solicitado
Construir a landing page completa (página única) **inteiramente no estilo do design system abaixo**, responsiva (testar 320px / 768px / 1024px / 1440px+), acessível (respeitar `prefers-reduced-motion`, contraste, foco visível, alvos de toque ≥44px) e com o agendamento via WhatsApp como ação central.
</project-brief>
